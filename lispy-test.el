...
(ert-deftest lispy-decode-keysequence ()
  (message "lispy-decode-keysequence")
...
(ert-deftest lispy-forward ()
  ...
  (should (string= (lispy-with "((a) |(b) (c))" (lispy-forward 1))
                   "((a) (b)| (c))"))
  (should (string= (lispy-with "(|(a) (b) (c))" (progn (lispy-forward 1)
                                                       (lispy-forward 1)))
                   "((a) (b)| (c))"))
  (should (string= (lispy-with "(|(a) (b) (c))" (lispy-forward 3))
                   "((a) (b) (c)|)"))
  (should (string= (lispy-with "(|(a) (b) (c))" (progn (lispy-forward 1)
                                                       (lispy-forward 1)
                                                       (lispy-forward 1)
                                                       (lispy-forward 1)))
                   "((a) (b) (c))|"))
  (should (string= (lispy-with "(|(a) (b) (c))" (lispy-forward 4))
                   "((a) (b) (c)|)"))
  (should (string= (lispy-with "(|(a) (b) (c))" (lispy-forward 40))
                   "((a) (b) (c)|)"))
  ...
  (should (string= (lispy-with "(|(a) (b) (c))"
                               ...
                               (call-interactively 'kill-region))
                   "(~| (c))"))
  (should (lispy-with-v el "(|(a) (b) (c))"
                        (set-mark (point))
                        (progn (lispy-forward 1)
                               (lispy-forward 1)
                               (lispy-forward 1))
                        (region-active-p)))
  ...
  (should (not (lispy-with-v el "(|(a) (b) (c))"
                             (set-mark (point))
                             (progn (lispy-forward 1)
                                    (lispy-forward 1)
                                    (lispy-forward 1)
...
(ert-deftest lispy-backward ()
  (message "lispy-backward")
  (should (string= (lispy-with "(|(a) (b) (c))" (lispy-backward 1))
                   "|((a) (b) (c))"))
  (should (string= (lispy-with "((a)|)" (lispy-backward 1))
                   "(|(a))"))
  (should (string= (lispy-with "((|a) (b) (c))" (lispy-backward 1))
                   "(|(a) (b) (c))"))
  (should (string= (lispy-with "((a) |(b) (c))" (lispy-backward 1))
                   "(|(a) (b) (c))"))
  (should (string= (lispy-with "(|(a) (b) (c))" (progn (lispy-backward 1)
                                                       (lispy-backward 1)))
                   "|((a) (b) (c))"))
  (should (string= (lispy-with "(|(a) (b) (c))" (lispy-backward 3))
                   "|((a) (b) (c))"))
  (should (string= (lispy-with "((a) (b) (c)|)" (lispy-backward 1))
                   "((a) (b) |(c))"))
  (should (string= (lispy-with "((a) (b) (c)|)" (lispy-backward 4))
                   "(|(a) (b) (c))"))
  (should (string= (lispy-with "((a) (b) (c)|)" (lispy-backward 40))
                   "(|(a) (b) (c))"))
  (should (string= (lispy-with "((b)|\"foo\")" (lispy-backward 1))
                   "(|(b)\"foo\")"))
  (should (string= (lispy-with "(bar)\n;; (foo baar)|" (lispy-backward 1))
                   "|(bar)\n;; (foo baar)"))
  (should (string= (lispy-with "(foo)\n;; (foo bar\n;;      tanf)|" (lispy-backward 1))
                   "|(foo)\n;; (foo bar\n;;      tanf)")))
...
(ert-deftest lispy-right ()
  ...
  (should (string= (lispy-with "((a) \"(|foo)\" (c))" (lispy-right 2))
                   "((a) \"(foo)\" (c))|"))
  (should (string= (lispy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (lispy-right 1))
                   "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something))|))"))
  (should (string= (lispy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (lispy-right 2))
                   "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)))|)"))
  (should (string= (lispy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (lispy-right 3))
                   "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something))))|"))
  (should (string= (lispy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (lispy-right 9))
  ...
  (should (string= (lispy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      |(something))))" (lispy-right 9))
                   "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something))))|"))
  (should (string= (lispy-with "|(foo)~" (lispy-right 1))
                   "~(foo)|"))
  (should (string= (lispy-with "~(foo)|" (lispy-right 1))
                   "~(foo)|"))
...
(ert-deftest lispy-move-left ()
  (message "lispy-move-left")
  (should (string= (lispy-with "(progn\n |(sexp1)\n (sexp2))" (lispy-move-left 1))
                   "|(sexp1)\n(progn\n  (sexp2))")))

(ert-deftest lispy-down-slurp ()
  (message "lispy-down-slurp")
  (should (string= (lispy-with "(progn\n\n  |(sexp1)\n  (sexp2))" (lispy-down-slurp))
                   "(progn\n\n  (|(sexp1)\n   sexp2))"))
  (should (string= (lispy-with "|(fee) (fi) [fo]" (lispy-down-slurp))
                   "(|(fee)\n fi) [fo]"))
  (should (string= (lispy-with "(fee) |(fi) [fo]" (lispy-down-slurp))
                   "(fee) [|(fi)\n       fo]")))
...
(ert-deftest lispy-left ()
  (message "lispy-left")
  (should (string= (lispy-with "(|(a) (b) (c))" (lispy-left 1))
                   "|((a) (b) (c))"))
  (should (string= (lispy-with "(|(a) (b) (c))" (lispy-left 2))
                   "|((a) (b) (c))"))
  (should (string= (lispy-with "((a)| (b) (c))" (lispy-left 1))
                   "|((a) (b) (c))"))
  (should (string= (lispy-with "((a) (b)| (c))" (lispy-left 1))
  ...
  (should (string= (lispy-with "((a) |(b) (c))" (lispy-left 1))
                   "|((a) (b) (c))"))
  (should (string= (lispy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (lispy-left 1))
                   "(defun foo ()\n  (let ((a 1))\n    |(let ((b 2))\n      (something))))"))
  (should (string= (lispy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (lispy-left 2))
                   "(defun foo ()\n  |(let ((a 1))\n    (let ((b 2))\n      (something))))"))
  (should (string= (lispy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (lispy-left 3))
                   "|(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something))))"))
  (should (string= (lispy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (lispy-left 9))
                   "|(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something))))"))
  (should (string= (lispy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      |(something))))" (lispy-left 1))
                   "(defun foo ()\n  (let ((a 1))\n    |(let ((b 2))\n      (something))))"))
  (should (string= (lispy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      |(something))))" (lispy-left 2))
  ...
  (should (equal (lispy-with "((foo \"(\"))\n((foo \")\"))\n\"un|expected\"" (lispy-backward 1))
                 "((foo \"(\"))\n|((foo \")\"))\n\"unexpected\""))
  (should (equal (lispy-with "(defun charge! ()\n|(run-away))" (lispy-left 1))
                 "|(defun charge! ()\n  (run-away))"))
  (should (string= (lispy-with "|(foo)~" (lispy-left 1))
                   "|(foo)~"))
  (should (string= (lispy-with "~(foo)|" (lispy-left 1))
                   "|(foo)~")))
...
(ert-deftest lispy-flow ()
  (message "lispy-flow")
  (should (string= (lispy-with "(|(a) (b) (c))" (lispy-flow 1))
                   "((a) |(b) (c))"))
  (should (string= (lispy-with "(|(a) (b) (c))" (lispy-flow 2))
                   "((a) (b) |(c))"))
  (should (string= (lispy-with "((a)| (b) (c))" (lispy-flow 1))
                   "((a)| (b) (c))"))
  (should (string= (lispy-with "((a) (b)| (c))" (lispy-flow 1))
  ...
  (should (string= (lispy-with "((a) |(b) (c))" (lispy-flow 1))
                   "((a) (b) |(c))"))
  (should (string= (lispy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (lispy-flow 1))
                   "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))|\n      (something))))"))
  (should (string= (lispy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (lispy-flow 2))
                   "(defun foo ()\n  (let ((a 1))\n    (let ((b 2)|)\n      (something))))"))
  (should (string= (lispy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (lispy-flow 3))
                   "(defun foo ()\n  (let ((a 1))|\n    (let ((b 2))\n      (something))))"))
  (should (string= (lispy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (lispy-flow 9))
                   "(defun foo ()|\n  (let ((a 1))\n    (let ((b 2))\n      (something))))"))
  (should (string= (lispy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      |(something))))" (lispy-flow 1))
                   "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      |(something))))"))
  (should (string= (lispy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      |(something))))" (lispy-flow 2))
...
(ert-deftest lispy--sub-slurp-forward ()
  (message "lispy--sub-slurp-forward")
...
(ert-deftest lispy--sub-slurp-backward ()
  (message "lispy--sub-slurp-backward")
  (should (eq (lispy-with-v el "(progn\n  foo-bar-baz-flip-|flop~)"
...
(ert-deftest lispy-slurp ()
  ...
  (should (string= (lispy-with "(foo) #_|(bar)~ (baz)" ">")
                   "(foo) |#_(bar)~ (baz)"))
  (should (string= (lispy-with "|(a) (b) (c)" "v>")
                   "~(a) (b)| (c)"))
...
(ert-deftest lispy-splice ()
  (message "lispy-splice")
  (should (string= (lispy-with "(|(a) (b) (c))" (lispy-splice 1))
                   "(a |(b) (c))"))
  (should (string= (lispy-with "((a) |(b) (c))" (lispy-splice 1))
                   "((a) b |(c))"))
  (should (string= (lispy-with "(|(a) (b) (c))" (progn (lispy-splice 1)
                                                       (lispy-splice 1)
                                                       (lispy-splice 1)))
                   "|(a b c)"))
  (should (string= (lispy-with "((a) (b) (c)|)" (lispy-splice 1))
  ...
  (should (string= (lispy-with "(asdf)\n(progn\n  (foo)\n  (bar)|)\n(asdf)"
                   ...
                   "(asdf)\n(progn\n  foo\n  bar)|\n(asdf)"))
  ;; test that quotes also get deleted
  (should (string= (lispy-with "'|(a)" (lispy-splice 1))
                   "|a"))
  (should (string= (lispy-with "(,@|(a))" (lispy-splice 1))
                   "|(a)"))
  (should (string= (lispy-with "#2A|((a b) (0 1))" (lispy-splice 1))
                   "|(a b) (0 1)"))
  ;; let splicing
...
(ert-deftest lispy-move-up-region ()
  (message "lispy-move-up-region")
  (should (string= (lispy-with "(lisp sugar-~free|)" (lispy-move-up 1))
                   "(lisp |free~-sugar)"))
  (should (string= (lispy-with "(lisp sugar-~free|)" (progn (lispy-move-up 1)
                                                            (lispy-move-up 1)))
                   "(lisp |free~-sugar)"))
  (should (string= (lispy-with "sugar-~free|-lisp" (lispy-move-up 1))
                   "|free~-sugar-lisp"))
  (should (string= (lispy-with "sugar-free-|lisp~" (lispy-move-up 1))
                   "sugar-~lisp|-free"))
  (should (string= (lispy-with "sugar-free-|lisp~" (progn (lispy-move-up 1)
                                                          (lispy-move-up 1)))
                   "|lisp~-sugar-free")))

(ert-deftest lispy-move-down-region ()
  (message "lispy-move-down-region")
  (should (string= (lispy-with "(~sugar|-free lisp)" (lispy-move-down 1))
                   "(free-~sugar| lisp)"))
  (should (string= (lispy-with "(|sugar~-free lisp)" (lispy-move-down 1))
                   "(free-|sugar~ lisp)"))
  (should (string= (lispy-with "(|sugar~-free lisp)" (progn (lispy-move-down 1)
                                                            (lispy-move-down 1)))
                   "(free-|sugar~ lisp)"))
  (should (string= (lispy-with clojure "(list\n  {&:bar \"foo\"|\n   :foo \"bar\"})" (lispy-move-down 2))
                   "(list\n  {:foo \"bar\"\n   &:bar \"foo\"|})")))
...
(ert-deftest lispy-move-end-of-line ()
  (message "lispy-move-end-of-line")
...
(ert-deftest lispy-move-beginning-of-line ()
  (message "lispy-move-beginning-of-line")
...
(ert-deftest lispy-string-oneline ()
  (message "lispy-string-oneline")
  (should (string= (lispy-with "\"foo\nb|ar\n\"" (lispy-string-oneline))
                   "\"foo\\nbar\\n\"|")))

(ert-deftest lispy-stringify ()
  (message "lispy-stringify")
  (should (string= (lispy-with "(a\n b\n (foo)\n c)|" (lispy-stringify))
                   "\"(a\n b\n (foo)\n c)|\""))
  (should (string= (lispy-with "(progn |(1 2 3))" (lispy-stringify))
                   "(progn \"|(1 2 3)\")"))
  (should (string= (lispy-with "(foo |(bar #\\x \"baz \\\\ quux\") zot)" (lispy-stringify))
                   "(foo \"|(bar #\\\\x \\\"baz \\\\\\\\ quux\\\")\" zot)"))
  (should (string= (lispy-with "(list ~one|\n      two\n      five)" (lispy-stringify))
                   "(list ~\"one\"|\n      two\n      five)"))
  (should (string= (lispy-with "(list ~one|\n      two\n      five)" (progn (lispy-stringify)
                                                                            (lispy-down 1)
                                                                            (lispy-stringify)
                                                                            (lispy-down 1)
                                                                            (lispy-stringify)))
...
(ert-deftest lispy--prettify-1 ()
  (message "lispy--prettify-1")
  (should (string= (lispy-with "|(foo (bar)baz)" (lispy--prettify-1))
                   "|(foo (bar) baz)"))
  (should (string= (lispy-with "(foo (bar)baz)|" (lispy--prettify-1))
                   "(foo (bar) baz)|"))
  (should (string= (lispy-with "|(bar\n  foo )" (lispy--prettify-1))
                   "|(bar\n foo)"))
  (should (string= (lispy-with "|(foo \")\")" (lispy--prettify-1))
                   "|(foo \")\")"))
  (should (string= (lispy-with "|(foo     \n bar)" (lispy--prettify-1))
                   "|(foo\n bar)"))
  (should (string= (lispy-with "|(require' foo)" (lispy--prettify-1))
                   "|(require 'foo)"))
...
(ert-deftest lispy-up-slurp ()
  ...
  (should (string= (lispy-with "(progn\n  (foo))\n|(bar)\n(baz)~" (lispy-up-slurp))
                   "(progn\n  (foo)\n  |(bar)\n  (baz)~)"))
  (should (string= (lispy-with "[foo] |(bar)" (lispy-up-slurp))
                   "[foo |(bar)]"))
  (should (string= (lispy-with "(progn\n  (foo))\n~(bar)\n(baz)|" (lispy-up-slurp))
                   "(progn\n  (foo)\n  ~(bar)\n  (baz)|)"))
  (should (string= (lispy-with "(let ((a (1+))))\n|" (lispy-up-slurp))
...
(ert-deftest lispy-indent-adjust-parens ()
  (message "lispy-indent-adjust-parens")
...
(ert-deftest lispy-tab ()
  ...
  (should (string= (lispy-with clojure "|(let [:foo :bar\n:bax :xum])" "i")
                   "|(let [:foo :bar\n      :bax :xum])"))
...
(ert-deftest lispy-mark-list ()
  ...
  (should (string= (lispy-with "~(foo bar)|" (lispy-mark-list 0))
                   "(~foo bar|)"))
  (should (string= (lispy-with "(progn ,@(cdr re)|)" (lispy-mark-list 1))
                   "(progn |,@(cdr re)~)"))
  (should (string= (lispy-with "(progn ,@(cdr re)|)" (progn (lispy-mark-list 1)
                                                            (lispy-mark-list 1)))
                   "(progn ,@|(cdr re))"))
  (should (string= (lispy-with "(progn ,@|(cdr re))" (lispy-mark-list 1))
                   "(progn ~,@(cdr re)|)"))
  (should (string= (lispy-with "(progn ,@|(cdr re))" (progn (lispy-mark-list 1)
                                                            (lispy-mark-list 1)))
                   "(progn ,@(cdr re)|)"))
  (should (string= (lispy-with clojure "#|{:bar 'baz}" (lispy-mark-list 0))
                   "#{&:bar 'baz|}"))
  (should (string= (lispy-with "#2A|((a b) (0 1))" (lispy-mark-list 1))
                   "~#2A((a b) (0 1))|")))

(ert-deftest lispy-mark-car ()
  (message "lispy-mark-car")
  (should (string= (lispy-with "|\"foo\"~" (lispy-tab))
                   "\"~foo|\""))
  (should (string= (lispy-with "~'(\n  foo)|" (lispy-tab))
                   "'(\n  ~foo|)"))
  (should (string= (lispy-with "|'(\n  foo)~" (lispy-tab))
  ...
  (should (string= (lispy-with
                    ...
                    (progn (lispy-mark-list 1)
                           ...
                           (lispy-tab)))
                   "(add-to-list '~auto-mode-alist| '(\"\\\\.cache\\\\'\" . emacs-lisp-mode))"))
  (should (string= (lispy-with "\"See ~`plumage'|.\"" (lispy-tab))
                   "\"See `~plumage|'.\""))
  (should (string= (lispy-with "(list ~\"one\" \"two\"|)" (lispy-tab))
                   "(list ~\"one\"| \"two\")")))

(ert-deftest lispy-beginning-of-defun ()
  (message "lispy-beginning-of-defun")
...
(ert-deftest lispy-backward-kill-word ()
  (message "lispy-backward-kill-word")
...
(ert-deftest lispy-newline-and-indent-plain ()
  (message "lispy-newline-and-indent-plain")
...
(ert-deftest lispy-parens-auto-wrap ()
  (message "lispy-parens-auto-wrap")
...
(ert-deftest lispy-brackets-auto-wrap ()
  (message "lispy-brackets-auto-wrap")
  (lispy-set-key-theme '(parinfer))
  (should (string= (lispy-with "|a" "[")
                   "[| a]"))
  (should (string= (lispy-with "|a" (setq current-prefix-arg '-) "[")
...
(ert-deftest lispy-braces-auto-wrap ()
  (message "lispy-braces-auto-wrap")
  (lispy-set-key-theme '(parinfer))
  (should (string= (lispy-with "|a" "{")
                   "{| a}"))
  (should (string= (lispy-with "|a" (setq current-prefix-arg '-) "{")
...
(ert-deftest lispy-barf-to-point-nostring ()
  (message "lispy-barf-to-point-nostring")
  (lispy-set-key-theme '(parinfer))
  (should (string= (lispy-with "(a |\"b\" c)" ")")
                   "(a)| \"b\" c"))
  (should (string= (lispy-with "(a \"|b\" c)" ")")
...
(ert-deftest lispy-delete-backward-or-splice-or-slurp ()
  (message "lispy-delete-backward-or-splice-or-slurp")
  (lispy-set-key-theme '(parinfer))
...
(ert-deftest lispy-delete-or-splice-or-slurp ()
  (message "lispy-delete-or-splice-or-slurp")
  (lispy-set-key-theme '(parinfer))
...
(ert-deftest lispy-paredit-open-round ()
  (message "lispy-paredit-open-round")
  (should (string= (lispy-with "(a b |c d)"
                               "(")
                   "(a b (|) c d)"))
  (should (string= (lispy-with "(foo \"bar |baz\" quux)"
...
(ert-deftest lispy-paredit-close-round ()
  (message "lispy-paredit-close-round")
  (should (string= (lispy-with "(a b |c   )"
                               ")")
                   "(a b c)|"))
...
(ert-deftest lispy-paredit-close-round-and-newline ()
  (message "lispy-paredit-close-round-and-newline")
...
(ert-deftest lispy-paredit-open-square ()
  (message "lispy-paredit-open-square")
...
(ert-deftest lispy-paredit-close-square ()
  (message "lispy-paredit-close-square")
  (lispy-set-key-theme '(special paredit))
...
(ert-deftest lispy-paredit-doublequote ()
  (message "lispy-paredit-doublequote")
  (lispy-set-key-theme '(special paredit))
  (should (string= (lispy-with "(frob grovel |full lexical)"
                               "\"")
                   "(frob grovel \"|\" full lexical)"))
...
(ert-deftest lispy-paredit-meta-doublequote ()
  (message "lispy-paredit-meta-doublequote")
  (lispy-set-key-theme '(special paredit))
  (should (string= (lispy-with "(foo \"bar |baz\" quux)"
                               (kbd "M-\""))
                   "(foo \"bar baz\"| quux)"))
...
(ert-deftest lispy-paredit-forward-delete ()
  (message "lispy-paredit-forward-delete")
...
(ert-deftest lispy-paredit-backward-delete ()
  (message "lispy-paredit-backward-delete")
...
(ert-deftest lispy-paredit-forward-kill-word ()
  (message "lispy-paredit-forward-kill-word")
  (lispy-set-key-theme '(special paredit))
  (should (string= (lispy-with "|(foo bar)    ; baz"
                               (kbd "M-d"))
                   "(| bar)    ; baz"))
...
(ert-deftest lispy-paredit-backward-kill-word ()
  (message "lispy-paredit-backward-kill-word")
  (lispy-set-key-theme '(special paredit))
  (should (string= (lispy-with "(foo bar)    ; baz\n(quux)|"
                               (kbd "M-DEL"))
                   "(foo bar)    ; baz\n(|)"))
...
(ert-deftest lispy-paredit-backward ()
  (message "lispy-paredit-backward")
  (lispy-set-key-theme '(special paredit))
  (should (string= (lispy-with "(foo (bar baz)| quux)"
                               (kbd "C-M-b"))
                   "(foo |(bar baz) quux)"))
...
(ert-deftest lispy-paredit-wrap-round ()
  (message "lispy-paredit-wrap-round")
  (lispy-set-key-theme '(special paredit))
  (should (string= (lispy-with "(foo |bar baz)"
                               (kbd "M-("))
                   "(foo (| bar) baz)"))
...
(ert-deftest lispy-paredit-splice-sexp ()
  (message "lispy-paredit-splice-sexp")
  (lispy-set-key-theme '(special paredit))
  (should (string= (lispy-with "(foo (bar| baz) quux)"
                               (kbd "M-s"))
                   "(foo bar| baz quux)"))
...
(ert-deftest lispy-paredit-splice-sexp-killing-backward ()
  (message "lispy-paredit-splice-sexp-killing-backward")
  (lispy-set-key-theme '(special paredit))
...
(ert-deftest lispy-paredit-splice-sexp-killing-forward ()
  (message "lispy-paredit-splice-sexp-killing-forward")
  (lispy-set-key-theme '(special paredit))
  (should (string= (lispy-with "(a (b c| d e) f)"
                               (kbd "M-<down>"))
                   "(a b c| f)"))
...
(ert-deftest lispy-paredit-raise-sexp ()
  (message "lispy-paredit-raise-sexp")
  (lispy-set-key-theme '(special paredit))
...
(ert-deftest lispy-paredit-convolute-sexp ()
  (message "lispy-paredit-convolute-sexp")
  (lispy-set-key-theme '(special paredit))
...
(ert-deftest lispy-paredit-forward-slurp-sexp ()
  (message "lispy-paredit-forward-slurp-sexp")
  (lispy-set-key-theme '(special paredit))
...
(ert-deftest lispy-paredit-forward-barf-sexp ()
  (message "lispy-paredit-forward-barf-sexp")
  (lispy-set-key-theme '(special paredit))
  (should (string= (lispy-with "(foo (bar |baz quux) zot)"
                               (kbd "C-<left>"))
                   "(foo (bar |baz) quux zot)"))
...
(ert-deftest lispy-paredit-backward-slurp-sexp ()
  (message "lispy-paredit-backward-slurp-sexp")
  (lispy-set-key-theme '(special paredit))
  (should (string= (lispy-with "(foo bar (baz| quux) zot)"
                               (kbd "C-M-<left>"))
                   "(foo (bar baz| quux) zot)"))
...
(ert-deftest lispy-paredit-backward-barf-sexp ()
  (message "lispy-paredit-backward-barf-sexp")
  (lispy-set-key-theme '(special paredit))
  (should (string= (lispy-with "(foo (bar baz |quux) zot)"
                               (kbd "C-M-<right>"))
                   "(foo bar (baz |quux) zot)"))
...
(ert-deftest lispy-paredit-split-sexp ()
  (message "lispy-paredit-split-sexp")
  (lispy-set-key-theme '(special paredit))
  (should (string= (lispy-with "(hello| world)"
                               (kbd "M-S"))
                   "(hello)\n|( world)"))
...
(ert-deftest lispy-paredit-join-sexps ()
  (message "lispy-paredit-join-sexps")
  (lispy-set-key-theme '(special paredit))
  (should (string= (lispy-with "(hello)| (world)"
                               (kbd "M-J"))
                   "(hello world)|"))
...
(ert-deftest lispy-paredit-semicolon ()
  (message "lispy-paredit-semicolon")
  (lispy-set-key-theme '(special paredit))
