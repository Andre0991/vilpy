...
(ert-deftest vilpy-dedent-adjust-parens ()
  (message "vilpy-dedent-adjust-parens")
  ;; test reverse of vilpy-up-slurp on line with only closing parens
  (should (string= (vilpy-with "(let ((a (1+\n          |))))"
                               (vilpy-dedent-adjust-parens 1))
                   "(let ((a (1+)\n        |)))"))
  (should (string= (vilpy-with "(let ((a (1+)\n        |)))"
                               (vilpy-dedent-adjust-parens 1))
                   "(let ((a (1+))\n      |))"))
  ...
  ;; test counts
  (should (string= (vilpy-with "(let ((a (1+\n          |))))"
                               (vilpy-dedent-adjust-parens 3))
                   "(let ((a (1+)))\n  |)"))
  (should (string= (vilpy-with "(let ((a (1+\n          |))))"
                               (vilpy-dedent-adjust-parens 20))
                   "(let ((a (1+))))\n|"))
  (should (string= (vilpy-with "(((a)\n  |(b)\n  (c)\n  (d)))"
                               (vilpy-dedent-adjust-parens 2))
                   "(((a)))\n|(b)\n(c)\n(d)"))
...
(ert-deftest vilpy-left ()
  (message "vilpy-left")
  (should (string= (vilpy-with "(|(a) (b) (c))" (vilpy-left 1))
                   "|((a) (b) (c))"))
  (should (string= (vilpy-with "(|(a) (b) (c))" (vilpy-left 2))
                   "|((a) (b) (c))"))
  (should (string= (vilpy-with "((a)| (b) (c))" (vilpy-left 1))
                   "|((a) (b) (c))"))
  (should (string= (vilpy-with "((a) (b)| (c))" (vilpy-left 1))
  ...
  (should (string= (vilpy-with "((a) |(b) (c))" (vilpy-left 1))
                   "|((a) (b) (c))"))
  (should (string= (vilpy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (vilpy-left 1))
                   "(defun foo ()\n  (let ((a 1))\n    |(let ((b 2))\n      (something))))"))
  (should (string= (vilpy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (vilpy-left 2))
                   "(defun foo ()\n  |(let ((a 1))\n    (let ((b 2))\n      (something))))"))
  (should (string= (vilpy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (vilpy-left 3))
                   "|(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something))))"))
  (should (string= (vilpy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (vilpy-left 9))
                   "|(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something))))"))
  (should (string= (vilpy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      |(something))))" (vilpy-left 1))
                   "(defun foo ()\n  (let ((a 1))\n    |(let ((b 2))\n      (something))))"))
  (should (string= (vilpy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      |(something))))" (vilpy-left 2))
  ...
  (should (equal (vilpy-with "((foo \"(\"))\n((foo \")\"))\n\"un|expected\"" (vilpy-backward 1))
                 "((foo \"(\"))\n|((foo \")\"))\n\"unexpected\""))
  (should (equal (vilpy-with "(defun charge! ()\n|(run-away))" (vilpy-left 1))
                 "|(defun charge! ()\n  (run-away))"))
  (should (string= (vilpy-with "|(foo)~" (vilpy-left 1))
                   "|(foo)~"))
  (should (string= (vilpy-with "~(foo)|" (vilpy-left 1))
                   "|(foo)~")))

(ert-deftest vilpy-flow ()
  (message "vilpy-flow")
  (should (string= (vilpy-with "(|(a) (b) (c))" (vilpy-flow 1))
                   "((a) |(b) (c))"))
  (should (string= (vilpy-with "(|(a) (b) (c))" (vilpy-flow 2))
                   "((a) (b) |(c))"))
  (should (string= (vilpy-with "((a)| (b) (c))" (vilpy-flow 1))
                   "((a)| (b) (c))"))
  (should (string= (vilpy-with "((a) (b)| (c))" (vilpy-flow 1))
  ...
  (should (string= (vilpy-with "((a) |(b) (c))" (vilpy-flow 1))
                   "((a) (b) |(c))"))
  (should (string= (vilpy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (vilpy-flow 1))
                   "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))|\n      (something))))"))
  (should (string= (vilpy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (vilpy-flow 2))
                   "(defun foo ()\n  (let ((a 1))\n    (let ((b 2)|)\n      (something))))"))
  (should (string= (vilpy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (vilpy-flow 3))
                   "(defun foo ()\n  (let ((a 1))|\n    (let ((b 2))\n      (something))))"))
  (should (string= (vilpy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      (something)|)))" (vilpy-flow 9))
                   "(defun foo ()|\n  (let ((a 1))\n    (let ((b 2))\n      (something))))"))
  (should (string= (vilpy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      |(something))))" (vilpy-flow 1))
                   "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      |(something))))"))
  (should (string= (vilpy-with "(defun foo ()\n  (let ((a 1))\n    (let ((b 2))\n      |(something))))" (vilpy-flow 2))
...
(ert-deftest vilpy-yank ()
  ...
  (should (string= (vilpy-with "\"|\"" (kill-new "\"foo\"") (vilpy-yank))
                   "\"\\\"foo\\\"|\""))
  (let ((vilpy-safe-paste t)
        (vilpy-safe-actions-no-pull-delimiters-into-comments t))
    (should (string= (vilpy-with "\"|\"" (kill-new "{([\"a\"") (vilpy-yank))
                     "\"{([\\\"a\\\"])}|\""))
    (should (string= (vilpy-with "\"|\"" (kill-new "\"a\")}]") (vilpy-yank))
                     "\"[{(\\\"a\\\")}]|\""))
    (should (string= (vilpy-with "\"|\"" (kill-new "\"a\")]} ({[\"b\"")
                                 (vilpy-yank))
                     "\"{[(\\\"a\\\")]} ({[\\\"b\\\"]})|\""))
    (should (string= (vilpy-with "|" (kill-new "(a\n;;foo") (vilpy-yank))
                     "(a\n;;foo\n)|"))))
...
(ert-deftest vilpy-slurp ()
  ...
  (should (string= (vilpy-with "(foo) #_|(bar)~ (baz)" ">")
                   "(foo) |#_(bar)~ (baz)"))
  (should (string= (vilpy-with "|(a) (b) (c)" "v>")
                   "~(a) (b)| (c)"))
...
(ert-deftest vilpy-barf-to-point ()
  (message "vilpy-barf-to-point")
  (should (string= (vilpy-with "((a) (b)| (c))" (vilpy-barf-to-point nil))
                   "((a) (b))| (c)"))
  (should (string= (vilpy-with "((a) (b) |(c))" (vilpy-barf-to-point nil))
                   "((a) (b))| (c)"))
  (should (string= (vilpy-with "((a)| (b) (c))" (vilpy-barf-to-point nil))
  ...
  (should (string= (vilpy-with "(a |\"b\" c)" (vilpy-barf-to-point nil))
                   "(a)| \"b\" c"))
  (should (string= (vilpy-with "((a) |(b) (c))" (vilpy-barf-to-point t))
                   "(a) |((b) (c))"))
  (should (string= (vilpy-with "((a)| (b) (c))" (vilpy-barf-to-point t))
                   "(a) |((b) (c))"))
  (should (string= (vilpy-with "((a) (b) |(c))" (vilpy-barf-to-point t))
  ...
  (should (string= (vilpy-with "(a \"b\"| c)" (vilpy-barf-to-point t))
                   "a \"b\" |(c)"))
  (should (string= (vilpy-with "a|" (vilpy-barf-to-point nil))
                   "a|"))
  (should (string= (vilpy-with "((a) (b) (c))|" (vilpy-barf-to-point nil))
                   "((a) (b) (c))|"))
  (should (string= (vilpy-with "((a b c|))" (vilpy-barf-to-point nil))
...
(ert-deftest vilpy-clone ()
  ...
  (should (string= (vilpy-with "(foo |(bar)~)" "c")
                   "(foo |(bar)~\n     (bar))"))
  (should (string= (vilpy-with "(progn '|(foo))" "c")
                   "(progn '|(foo)\n       '(foo))"))
  (should (string= (vilpy-with "(progn '(foo)|)" "c")
                   "(progn '(foo)\n       '(foo)|)"))
...
(ert-deftest vilpy-indent-adjust-parens ()
  (message "vilpy-indent-adjust-parens")
  ;; fix incorrect indentation
  (should (string= (vilpy-with "(a\n|)" (vilpy-indent-adjust-parens 1))
                   "(a\n |)"))
  (should (string= (vilpy-with "(a\n  |  )\n" (vilpy-indent-adjust-parens 1))
                   "(a\n |)\n"))
  (should (string= (vilpy-with "(a\n  ~(b c)\n   (d e)\n    (|f g)"
  ...
  (should (string= (vilpy-with "(a|)" (vilpy-indent-adjust-parens 1))
                   "(a|)"))
  ;; otherwise call vilpy-up-slurp
  (should (string= (vilpy-with "(let ((a (1+))))\n|"
                               (vilpy-indent-adjust-parens 1))
                   "(let ((a (1+)))\n  |)"))
  (should (string= (vilpy-with "(progn\n  (foo))\n~(bar)\n(baz)|"
  ...
  (should (string= (vilpy-with "(foo (bar))\n|baz bif"
                   ...
                   "(foo (bar)\n     |baz bif)"))
  ;; multi-line list
  (should (string= (vilpy-with "(a)\n|(b\n c)" (vilpy-indent-adjust-parens 1))
                   "(a\n |(b\n  c))"))
  ;; test counts
  (should (string= (vilpy-with "(let ((a (1+))))\n|"
                               (vilpy-indent-adjust-parens 3))
                   "(let ((a (1+)\n        |)))"))
  (should (string= (vilpy-with "(let ((a (1+))))\n|"
                               (vilpy-indent-adjust-parens 20))
                   "(let ((a (1+\n          |))))")))

(ert-deftest vilpy-tab ()
  (message "vilpy-tab")
  (should (string= (vilpy-with "|(defun test?  (x) x)" "i")
                   "|(defun test? (x) x)"))
  (should (string= (vilpy-with "|(list '{foobar)" "i")
                   "|(list '{foobar)"))
  (should (string= (vilpy-with "|(setq x '(\n          \n          ))" "i")
                   "|(setq x '())"))
  (should (string= (vilpy-with "|(eq (char-before) ?\\()" "i")
                   "|(eq (char-before) ?\\()"))
  (should (string= (vilpy-with "`|[1  2  3]" "i")
                   "`|[1 2 3]"))
  (should (string= (vilpy-with "   |(defun)" "i")
                   "|(defun)"))
  (should (string= (vilpy-with "|;; comment 1\n;; comment 2" "i")
                   "|;; comment 1\n;; comment 2"))
  (should (string= (vilpy-with "|(list \"\\\"\")" "i")
                   "|(list \"\\\"\")"))
  (should (string= (vilpy-with "|(modify-syntax-entry ?' \"\\\"\" table)" "i")
                   "|(modify-syntax-entry ?' \"\\\"\" table)"))
  (should (string= (vilpy-with clojure "|(let [:foo :bar\n:bax :xum])" "i")
                   "|(let [:foo :bar\n      :bax :xum])"))
  (should (equal (vilpy-with "|(pcase :bar\n    (`,pat pat))" "i")
                 "|(pcase :bar\n  (`,pat pat))"))
  (should (equal (vilpy-with "'|(27 ?\\C-g)" "i")
                 "'|(27 ?\\C-g)")))
...
(ert-deftest vilpy-parens-auto-wrap ()
  (message "vilpy-parens-auto-wrap")
  (vilpy-set-key-theme '(parinfer))
  (should (string= (vilpy-with "|a" "(")
                   "(| a)"))
  (should (string= (vilpy-with "|a" (setq current-prefix-arg '-) "(")
                   "(|) a"))
  (should (string= (vilpy-with "(a)| (b)" "(")
                   "(a) (| (b))"))
...
(ert-deftest vilpy-delete-backward-or-splice-or-slurp ()
  ...
  (vilpy-set-key-theme '(parinfer))
  (should (string= (vilpy-with "(|a b c)" (kbd "DEL"))
                   "|a b c"))
  (should (string= (vilpy-with "(|(a b c))" (kbd "DEL"))
                   "|(a b c)"))
  (should (string= (vilpy-with "(a |b c)" (kbd "DEL") (kbd "DEL"))
                   "(|b c)"))
  (should (string= (vilpy-with "((a b)| c)" (kbd "DEL"))
                   "((a b| c))"))
  (should (string= (vilpy-with "(a)| (b)" (kbd "DEL"))
                   "(a| (b))"))
  (should (string= (vilpy-with "(((a)))|" (kbd "DEL") (kbd "DEL") (kbd "DEL"))
                   "(((a|)))"))
  (should (string= (vilpy-with ";; (a (b)| c)"
  ...
  (should (string= (vilpy-with "\"|a b c\"" (kbd "DEL"))
                   "|"))
  ;; space cleanup
  (should (string= (vilpy-with "(foo (| (bar) baz))" (kbd "DEL"))
                   "(foo |(bar) baz)"))
  ;; test that quotes also get deleted
  (should (string= (vilpy-with "'(|)" (kbd "DEL"))
                   "|"))
  (should (string= (vilpy-with "(,@(|))" (kbd "DEL"))
                   "(|)"))
...
(ert-deftest vilpy-delete-or-splice-or-slurp ()
  ...
  (vilpy-set-key-theme '(parinfer))
  (should (string= (vilpy-with "|(a b c)" (kbd "C-d"))
                   "|a b c"))
  (should (string= (vilpy-with "(|(a b c))" (kbd "C-d"))
                   "(|a b c)"))
  (should (string= (vilpy-with "(a |b c)" (kbd "C-d") (kbd "C-d"))
                   "(a |c)"))
  (should (string= (vilpy-with "((a b|) c)" (kbd "C-d"))
                   "((a b| c))"))
  (should (string= (vilpy-with "(a|) (b)" (kbd "C-d"))
                   "(a| (b))"))
  (should (string= (vilpy-with "(((a|)))" (kbd "C-d") (kbd "C-d") (kbd "C-d"))
                   "(((a)))|"))
  (should (string= (vilpy-with ";; (a |(b) c)"
                               (setq current-prefix-arg 4)
                               (kbd "C-d"))
  ...
  (should (string= (vilpy-with "|\"a b c\"" (kbd "C-d"))
                   "|"))
  ;; test that quotes also get deleted
  (should (string= (vilpy-with "'|()" (kbd "C-d"))
                   "|"))
  (should (string= (vilpy-with "(,@|())" (kbd "C-d"))
                   "(|)"))
...
(ert-deftest vilpy-paredit-open-round ()
  (message "vilpy-paredit-open-round")
  (should (string= (vilpy-with "(a b |c d)"
                               "(")
                   "(a b (|) c d)"))
  (should (string= (vilpy-with "(foo \"bar |baz\" quux)"
...
(ert-deftest vilpy-paredit-close-round ()
  (message "vilpy-paredit-close-round")
  (should (string= (vilpy-with "(a b |c   )"
                               ")")
                   "(a b c)|"))
  (should (string= (vilpy-with "; Hello,| world!"
                               ")")
                   "; Hello,)| world!")))

(ert-deftest vilpy-paredit-close-round-and-newline ()
  (message "vilpy-paredit-close-round-and-newline")
  (vilpy-set-key-theme '(paredit))
  (should (string= (vilpy-with "(defun f (x|  ))"
                               (kbd "M-)"))
                   "(defun f (x)\n  |)"))
  (should (string= (vilpy-with "; (Foo.|"
                               (kbd "M-)"))
...
(ert-deftest vilpy-paredit-open-square ()
  (message "vilpy-paredit-open-square")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(a b |c d)"
                               "[")
                   "(a b [|] c d)"))
  (should (string= (vilpy-with "(foo \"bar |baz\" quux)"
...
(ert-deftest vilpy-paredit-close-square ()
  (message "vilpy-paredit-close-square")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(define-key keymap [frob|  ] 'frobnicate)"
                               "]")
...
(ert-deftest vilpy-paredit-doublequote ()
  (message "vilpy-paredit-doublequote")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(frob grovel |full lexical)"
                               "\"")
                   "(frob grovel \"|\" full lexical)"))
...
(ert-deftest vilpy-paredit-meta-doublequote ()
  (message "vilpy-paredit-meta-doublequote")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(foo \"bar |baz\" quux)"
                               (kbd "M-\""))
                   "(foo \"bar baz\"| quux)"))
...
(ert-deftest vilpy-paredit-newline ()
  (message "vilpy-paredit-newline")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(let ((n (frobbotz))) |(display (+ n 1)\nport))"
                               (kbd "C-j"))
                   "(let ((n (frobbotz)))\n  |(display (+ n 1)\n           port))"))
  (vilpy-set-key-theme '(special vilpy c-digits oleh)))

(ert-deftest vilpy-paredit-forward-delete ()
  (message "vilpy-paredit-forward-delete")
  (should (string= (vilpy-with "(quu|x \"zot\")" (vilpy-forward-delete 1))
                   "(quu| \"zot\")"))
  (should (string= (vilpy-with "(foo (|) bar)" (vilpy-forward-delete 1))
                   "(foo | bar)"))
  (should (string= (vilpy-with "|(foo bar)" (vilpy-forward-delete 1))
                   "(|foo bar)"))
  (should (string= (vilpy-with "(quux |\"zot\")" (vilpy-forward-delete 1))
                   "(quux \"|zot\")"))
  (should (string= (vilpy-with "(quux \"|zot\")" (vilpy-forward-delete 1))
                   "(quux \"|ot\")"))
  (should (string= (vilpy-with "(foo (|))" (vilpy-forward-delete 1))
                   "(foo |)"))
  (should (string= (vilpy-with "\"|\"" (vilpy-forward-delete 1))
                   "|"))
  (should (string= (vilpy-with "(baz \"foobar|\")" (vilpy-forward-delete 1))
                   "(baz |\"foobar\")"))
  (should (string= (vilpy-with "(foo (bar|))" (vilpy-forward-delete 1))
                   "(foo |)")))

(ert-deftest vilpy-paredit-backward-delete ()
  (message "vilpy-paredit-backward-delete")
  (should (string= (vilpy-with "(\"zot\" q|uux)" (vilpy-backward-delete 1))
                   "(\"zot\" |uux)"))
  (should (string= (vilpy-with "(\"zot\"| quux)" (vilpy-backward-delete 1))
                   "(\"zot|\" quux)"))
  (should (string= (vilpy-with "(\"zot|\" quux)" (vilpy-backward-delete 1))
                   "(\"zo|\" quux)"))
  (should (string= (vilpy-with "(foo (|) bar)" (vilpy-backward-delete 1))
                   "(foo | bar)"))
  (should (string= (vilpy-with "(foo bar)|" (vilpy-backward-delete 1))
                   "(foo bar|)"))
  (should (string= (vilpy-with "(|)" (vilpy-backward-delete 1))
                   "|"))
  (should (string= (vilpy-with "(foo (|))" (vilpy-backward-delete 1))
                   "(foo |)"))
  (should (string= (vilpy-with "\"|\"" (vilpy-backward-delete 1))
                   "|"))
  (should (string= (vilpy-with "(baz \"|foobar\")" (vilpy-backward-delete 1))
                   "(baz \"foobar\"|)"))
  (should (string= (vilpy-with "(foo (|bar))" (vilpy-backward-delete 1))
                   "(foo |)")))

(ert-deftest vilpy-paredit-kill ()
  (message "vilpy-paredit-kill")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(foo bar)|     ; Useless comment!"
                               (kbd "C-k"))
                   "(foo bar)|"))
  (should (string= (vilpy-with "(|foo bar)     ; Useful comment!"
                               (kbd "C-k"))
                   "(|)     ; Useful comment!"))
  (should (string= (vilpy-with "|(foo bar)     ; Useless line!"
                               (kbd "C-k"))
                   "|"))
  (should (string= (vilpy-with "(foo \"|bar baz\"\n     quux)"
                               (kbd "C-k"))
                   "(foo \"|\"\n     quux)"))
  (vilpy-set-key-theme '(special vilpy c-digits oleh)))

(ert-deftest vilpy-paredit-forward-kill-word ()
  (message "vilpy-paredit-forward-kill-word")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "|(foo bar)    ; baz"
                               (kbd "M-d"))
                   "(| bar)    ; baz"))
  (should (string= (vilpy-with "(| bar)    ; baz"
                               (kbd "M-d"))
                   "(|)    ; baz"))
  (should (string= (vilpy-with "(|)    ; baz"
                               (kbd "M-d"))
                   "()    ;|"))
  (should (string= (vilpy-with ";;;| Frobnicate\n(defun frobnicate ...)"
                               (kbd "M-d"))
                   ";;;|\n(defun frobnicate ...)"))
  (should (string= (vilpy-with ";;;|\n(defun frobnicate ...)"
                               (kbd "M-d"))
...
(ert-deftest vilpy-paredit-backward-kill-word ()
  (message "vilpy-paredit-backward-kill-word")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(foo bar)    ; baz\n(quux)|"
                               (kbd "M-DEL"))
                   "(foo bar)    ; baz\n(|)"))
...
(ert-deftest vilpy-paredit-forward ()
  (message "vilpy-paredit-forward")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(foo |(bar baz) quux)"
                               (kbd "C-M-f"))
                   "(foo (bar baz)| quux)"))
...
(ert-deftest vilpy-paredit-backward ()
  (message "vilpy-paredit-backward")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(foo (bar baz)| quux)"
                               (kbd "C-M-b"))
                   "(foo |(bar baz) quux)"))
...
(ert-deftest vilpy-paredit-wrap-round ()
  (message "vilpy-paredit-wrap-round")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(foo |bar baz)"
                               (kbd "M-("))
                   "(foo (| bar) baz)"))
...
(ert-deftest vilpy-paredit-splice-sexp ()
  (message "vilpy-paredit-splice-sexp")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(foo (bar| baz) quux)"
                               (kbd "M-s"))
                   "(foo bar| baz quux)"))
...
(ert-deftest vilpy-paredit-splice-sexp-killing-backward ()
  (message "vilpy-paredit-splice-sexp-killing-backward")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(foo (let ((x 5)) |(sqrt n)) bar)"
                               (kbd "M-<up>"))
                   "(foo |(sqrt n) bar)"))
  (should (string= (vilpy-with "(progn (1) |(2) (3))"
                               (kbd "M-<up>"))
                   "|(2) (3)"))
  (should (string= (vilpy-with "(a (b c |d e) f)"
                               (kbd "M-<up>"))
                   "(a d e| f)"))
  (vilpy-set-key-theme '(special vilpy c-digits oleh)))

(ert-deftest vilpy-paredit-splice-sexp-killing-forward ()
  (message "vilpy-paredit-splice-sexp-killing-forward")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(a (b c| d e) f)"
                               (kbd "M-<down>"))
                   "(a b c| f)"))
  (should (string= (vilpy-with "((a) (b) (c)| (d) (f))"
                               (kbd "M-<down>"))
                   "(a) (b) (c)|"))
  (vilpy-set-key-theme '(special vilpy c-digits oleh)))

(ert-deftest vilpy-paredit-raise-sexp ()
  (message "vilpy-paredit-raise-sexp")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(dynamic-wind in (lambda () |body) out)"
                               (kbd "M-r"))
                   "(dynamic-wind in |body out)"))
  (should (string= (vilpy-with "(dynamic-wind in |body out)"
                               (kbd "M-r"))
                   "|body"))
  (should (string= (vilpy-with "(foo bar\n     (baz 1 2 3\n          (+ 2 3)|))"
                               (kbd "M-r"))
...
(ert-deftest vilpy-paredit-convolute-sexp ()
  (message "vilpy-paredit-convolute-sexp")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(let ((x 5) (y 3)) (frob |(zwonk)) (wibblethwop))"
                               (kbd "M-?"))
                   "(frob |(let ((x 5) (y 3)) (zwonk) (wibblethwop)))"))
  (vilpy-set-key-theme '(special vilpy c-digits oleh)))

(ert-deftest vilpy-paredit-forward-slurp-sexp ()
  (message "vilpy-paredit-forward-slurp-sexp")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(foo (bar |baz) quux zot)"
                               (kbd "C-<right>"))
                   "(foo (bar |baz quux) zot)"))
  (vilpy-set-key-theme '(special vilpy c-digits oleh)))

(ert-deftest vilpy-paredit-forward-barf-sexp ()
  (message "vilpy-paredit-forward-barf-sexp")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(foo (bar |baz quux) zot)"
                               (kbd "C-<left>"))
                   "(foo (bar |baz) quux zot)"))
...
(ert-deftest vilpy-paredit-backward-slurp-sexp ()
  (message "vilpy-paredit-backward-slurp-sexp")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(foo bar (baz| quux) zot)"
                               (kbd "C-M-<left>"))
                   "(foo (bar baz| quux) zot)"))
...
(ert-deftest vilpy-paredit-backward-barf-sexp ()
  (message "vilpy-paredit-backward-barf-sexp")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(foo (bar baz |quux) zot)"
                               (kbd "C-M-<right>"))
                   "(foo bar (baz |quux) zot)"))
...
(ert-deftest vilpy-paredit-split-sexp ()
  (message "vilpy-paredit-split-sexp")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(hello| world)"
                               (kbd "M-S"))
                   "(hello)\n|( world)"))
...
(ert-deftest vilpy-paredit-join-sexps ()
  (message "vilpy-paredit-join-sexps")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "(hello)| (world)"
                               (kbd "M-J"))
                   "(hello world)|"))
  (should (string= (vilpy-with "\"Hello, \"\n|\"world!\""
                               (kbd "M-J"))
                   "\"Hello, |world!\""))
  (vilpy-set-key-theme '(special vilpy c-digits oleh)))

(ert-deftest vilpy-paredit-semicolon ()
  (message "vilpy-paredit-semicolon")
  (vilpy-set-key-theme '(special paredit))
  (should (string= (vilpy-with "|(frob grovel)"
                               ";")
                   "|;; (frob grovel)"))
  (should (string= (vilpy-with "(frob |grovel)"
                               ";")
                   "|(frob ;; grovel\n )"))
  (should (string= (vilpy-with "(frob |grovel (bloit\n               zargh))"
                               ";")
                   "|(frob ;; grovel (bloit\n      ;;         zargh)\n )"))
  (should (string= (vilpy-with "(frob grovel)          |"
                               ";")
