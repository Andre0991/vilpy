...
(ert-deftest vilpy-open-line-below ()
  (should (string= (vilpy-with "|(foo)" (vilpy-open-line-below))
                   "(foo)\n|"))
  (should (string= (vilpy-with "(foo)|" (vilpy-open-line-below))
                   "(foo)\n|"))
  (should (string= (vilpy-with "(foo\n|(bar)\n(baz)" (vilpy-open-line-below))
                   "(foo\n(bar)\n|\n(baz)")))

(ert-deftest vilpy-open-line-above ()
  (let ((result (vilpy-with "(foo\n|(bar))" (vilpy-open-line-above)))
        (expected "(foo\n |\n(bar))"))
    (should (string= (vilpy-with "(foo\n|(bar))" (vilpy-open-line-above))
                     "(foo\n |\n(bar))"))
    (should (string= (vilpy-with "(foo\n(bar)|)" (vilpy-open-line-above))
